...
namespace qc
{
    ...
    struct mat<T, 2>
    {
        ...
        template <FloatingSubOf<T> U> mat & operator=(const mat2<U> & m);
    ...
    struct mat<T, 3>
    {
        ...
        template <FloatingSubOf<T> U> mat & operator=(const mat2<U> & m);
        template <FloatingSubOf<T> U> mat & operator=(const mat3<U> & m);
    ...
    struct mat<T, 4>
    {
        ...
        template <FloatingSubOf<T> U> mat & operator=(const mat2<U> & m);
        template <FloatingSubOf<T> U> mat & operator=(const mat3<U> & m);
        template <FloatingSubOf<T> U> mat & operator=(const mat4<U> & m);
    ...
    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator+=(mat<T1, n> & m, T2 v);
    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator+=(mat<T1, n> & m1, const mat<T2, n> & m2);

    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator-=(mat<T1, n> & m, T2 v);
    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator-=(mat<T1, n> & m1, const mat<T2, n> & m2);

    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator*=(mat<T1, n> & m, T2 v);
    template <Floating T1, FloatingSubOf<T1> T2, int n> mat<T1, n> & operator*=(mat<T1, n> & m1, const mat<T2, n> & m2); // THIS IS EQUIVALENT TO m1 = m2 * m1 !!!
    template <Floating T1, FloatingSubOf<T1> T2, int n> vec<T1, n> & operator*=(vec<T1, n> & v, const mat<T2, n> & m); // THIS IS EQUIVALENT TO v = m * v !!!
...
namespace qc
{
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline constexpr mat<T, 2>::mat(
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 2>::mat(const mat3<U> & m) :
        c1{m.c1},
        c2{m.c2}
    {}
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 2>::mat(const mat4<U> & m) :
        c1{m.c1},
        c2{m.c2}
    {}
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat2<T> & mat<T, 2>::operator=(const mat2<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
    ...
    template <Floating T>
    forceinline constexpr mat<T, 2>::operator bool() const
    {
        return *this == mat{};
    }

    template <Floating T>
    forceinline vec2<T> & mat<T, 2>::col(const int i)
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec2<T> mat<T, 2>::col(const int i) const
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec2<T> mat<T, 2>::row(const int i) const
    {
        return {c1[i], c2[i]};
    }
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec2<T> mat<T, 2>::col() const
    {
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec2<T> mat<T, 2>::row() const
    {
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline constexpr mat<T, 3>::mat(
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 3>::mat(const mat2<U> & m) :
        c1{m.c1},
        c2{m.c2},
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 3>::mat(const mat4<U> & m) :
        c1{m.c1},
        c2{m.c2},
        c3{m.c3}
    {}
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat3<T> & mat<T, 3>::operator=(const mat2<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
        c3 = {T(0), T(0), T(1)};
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat3<T> & mat<T, 3>::operator=(const mat3<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
        c3 = m.c3;
    ...
    template <Floating T>
    forceinline constexpr mat<T, 3>::operator bool() const
    {
        return *this == mat{};
    }

    template <Floating T>
    forceinline vec3<T> & mat<T, 3>::col(const int i)
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec3<T> mat<T, 3>::col(const int i) const
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec3<T> mat<T, 3>::row(const int i) const
    {
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec3<T> mat<T, 3>::col() const
    {
        if constexpr (i == 0) return c1;
        if constexpr (i == 1) return c2;
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec3<T> mat<T, 3>::row() const
    {
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline constexpr mat<T, 4>::mat(
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 4>::mat(const mat2<U> & m) :
        c1{m.c1},
        c2{m.c2},
    ...
    template <Floating T>
    template <Floating U>
    forceinline constexpr mat<T, 4>::mat(const mat3<U> & m) :
        c1{m.c1},
        c2{m.c2},
        c3{m.c3},
        c4{T(0.0), T(0.0), T(0.0), T(1.0)}
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat4<T> & mat<T, 4>::operator=(const mat2<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
        c3 = {T(0), T(0), T(1), T(0)};
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat4<T> & mat<T, 4>::operator=(const mat3<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
        c3 = m.c3;
    ...
    template <Floating T>
    template <FloatingSubOf<T> U>
    forceinline mat4<T> & mat<T, 4>::operator=(const mat4<U> & m)
    {
        c1 = m.c1;
        c2 = m.c2;
        c3 = m.c3;
    ...
    template <Floating T>
    forceinline constexpr mat<T, 4>::operator bool() const
    {
        return *this == mat{};
    }

    template <Floating T>
    forceinline vec4<T> & mat<T, 4>::col(const int i)
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec4<T> mat<T, 4>::col(const int i) const
    {
        return *(&c1 + i);
    }

    template <Floating T>
    forceinline vec4<T> mat<T, 4>::row(const int i) const
    {
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec4<T> mat<T, 4>::col() const
    {
        if constexpr (i == 0) return c1;
        if constexpr (i == 1) return c2;
        if constexpr (i == 2) return c3;
    ...
    template <Floating T>
    template <int i>
    forceinline constexpr vec4<T> mat<T, 4>::row() const
    {
        return {c1.template at<i>(), c2.template at<i>(), c3.template at<i>(), c4.template at<i>()};
    }

    template <Floating T1, FloatingSubOf<T1> T2, int n>
    ...
    forceinline constexpr mat<T, n> operator+(const mat<T, n> & m)
    {
        return m;
    }
    ...
    template <Floating T, int n>
    forceinline constexpr mat<T, n> nullMat()
    {
