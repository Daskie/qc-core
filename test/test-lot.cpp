...
{
    {
        ...
        ASSERT_EQ(lot.capacity(), 8u);
        ASSERT_EQ(lot.size(), 8u);
        ASSERT_EQ(lot, (IL<s32>{1, 2, 3, 4, 5, 6, 7, 8}));

        ASSERT_EQ(lot.push(9), 9);
        ASSERT_EQ(lot.capacity(), 16u);
        ASSERT_EQ(lot.size(), 9u);
        ASSERT_EQ(lot, (IL<s32>{1, 2, 3, 4, 5, 6, 7, 8, 9}));
    }
}
